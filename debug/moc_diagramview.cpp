...
QT_MOC_LITERAL(1, 12, 15), // "needsUndoBackup"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "DiagramView\0needsUndoBackup\0"
};
...
void DiagramView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->needsUndoBackup(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramView::needsUndoBackup)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DiagramView::needsUndoBackup()
{
